...
const projecten = [
  {
    id: 1,
    titel: "Zoo App (React)",
    periode: "CMT React – Opdracht 06",
    beschrijving:
      "Een interactieve Zoo-app gebouwd met React. Gebruikers kunnen dieren bekijken, filteren en informatie opvragen via componenten en props.",
    link: "https://github.com/Abderrezzak-Hamada/CMT-React-opdrachten/tree/main/opdracht-06-zoo-app",
    afbeelding: "../images/react.png", 
     afbeelding1: "../images/React.jpg", 
